...
public class Sesion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // processRequest(request, response);
        ...
        user = Integer.parseInt(request.getParameter("identificador"));
        pass = request.getParameter("contra");
            try {
               

                MUsuario user3 = new MUsuario();
                MUsuario validar = new MUsuario();
                user3 = user3.verificarUsuario(user, pass);
                
                switch(user3.getId_rol()){
                    case 111:
